...
public class MqttService extends Service implements MqttCallback
{
	...
	Handler handler = new Handler(new Handler.Callback() {
		...
		public boolean handleMessage(Message msg) {
			Toast.makeText(getApplicationContext(), "收到了", Toast.LENGTH_LONG).show();
			return false;
		}
	});
	...
	private static final String 	MQTT_BROKER = /*"m2m.eclipse.org"*/"192.168.10.164"; // Broker URL or IP Address
	...
	private synchronized MqttDeliveryToken sendKeepAlive()
		...
		mKeepAliveTopic.publish("ABC".getBytes(), MQTT_KEEP_ALIVE_QOS, true);
