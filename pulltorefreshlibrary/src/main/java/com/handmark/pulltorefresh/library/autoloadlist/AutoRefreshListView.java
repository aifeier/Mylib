...
public class AutoRefreshListView<T> extends PullToRefreshAdapterViewBase<ListView> {
	...
	public AutoRefreshListView(Context context, Mode mode) {
		super(context, mode);
	}

	public AutoRefreshListView(Context context, Mode mode, AnimationStyle style) {
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(AutoRefreshListView.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);
	...
	protected class InternalListView extends ListView implements EmptyViewMethodAccessor {
		...
		public void setEmptyView(View emptyView) {
			AutoRefreshListView.this.setEmptyView(emptyView);
		}
